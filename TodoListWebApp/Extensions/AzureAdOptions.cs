namespace Microsoft.AspNetCore.Authentication
{
    ...
    public class AzureAdOptions
    {
        ...
        /// <summary>
        /// Client Id (Application ID) of the TechTalkService, obtained from the Azure portal for that application
        /// </summary>
        public string TechTalkResourceId { get; set; }

        /// <summary>
        /// Base URL of the TechTalkService
        /// </summary>
        public string TechTalkBaseAddress { get; set; }
